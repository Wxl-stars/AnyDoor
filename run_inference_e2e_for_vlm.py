...
"""
--scene_json ss3://sdagent-shard-bj-baiducloud/wuxiaolei/vlm/e2e_for_vlm_-2_2_0_50.json
...
if __name__ == '__main__': 
    ...
    if args.save_path is not None:
        ...
        json_save_path = args.scene_json.replace(".json", f"_{TODAY}_fill_fake_{args.rank_id}.json")
