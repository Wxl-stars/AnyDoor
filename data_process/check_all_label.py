...
parser.add_argument("--key", type=str, required=True, default=None, help="random or template")
parser.add_argument("--date", type=str, required=True, default=None, help="random or template")
